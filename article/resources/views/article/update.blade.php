								...
								<div class="col-sm-5">
									<input type="text" class="form-control"
									   ...
									   data-msg-minlength="文章标题长度最小为5"
										placeholder="标题" id="title" name="Article[title]" value="{{ old('Article.title')?old('Article.title'):$article->title }}">
								</div>
								<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<textarea class="form-control"
										...
										placeholder="内容" id="content" name="Article[content]">{{ old('Article.content')?old('Article.content'):$article->content }}</textarea>
								</div>
								<div class="col-sm-5">
